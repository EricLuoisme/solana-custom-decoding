...
import com.solana.custom.handler.MetaplexDecodeHandler;
...
public class NftTest {
    ...
    public void nftInfoDataDecoding() throws JsonProcessingException {
        ...
        Optional<MetaplexAccountInfoData> metaplexAccountInfoData = MetaplexDecodeHandler.parseFullNftInfo(base64DataStr);
    ...
    public void compactNftInfoDataDecoding() throws JsonProcessingException {
        String base64DataStr = "";
        Optional<CompactNftInfo> compactNftInfo = MetaplexDecodeHandler.parseCompactNftInfo(base64DataStr);
    ...
    public void requestForConcreteNftJson() throws JsonProcessingException {
        ...
        String base64DataStr = "";
        Optional<MetaplexStandardJsonObj> opMetaplex = MetaplexDecodeHandler.accountInfoData2JsonObj(client, base64DataStr);
