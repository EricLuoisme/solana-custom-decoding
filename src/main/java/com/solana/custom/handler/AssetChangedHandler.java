...
import com.solana.custom.dto.InnerTxn;
...
import com.solana.custom.dto.extra.TokenBalanceDif;
...
import static com.solana.custom.constant.ProgramConstants.TOKEN_PROGRAM_ID;
...
public final class AssetChangedHandler {
    ...
    private static Map<String, AssetChanging> fillAddressBalanceChangingMap(List<String> accountKeys, Meta meta,
                                                                            String txnHash, Map<String, TokenBalanceDif> tokenBalanceMap) {
        ...
        for (int i = 0; i < accountKeys.size(); i++) {
            ...
            if (null != tokenBalanceDif) {
                ...
                BigInteger preRawTokenAmt = StringUtils.isNotBlank(preRawTokenAmtStr) ? new BigInteger(preRawTokenAmtStr) : BigInteger.ZERO;
                BigInteger postRawTokenAmt = StringUtils.isNotBlank(postRawTokenAmtStr) ? new BigInteger(postRawTokenAmtStr) : BigInteger.ZERO;
